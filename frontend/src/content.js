...
export const VISION = {
  title: "Why I Build",
  lead:
    "I believe technology is most powerful when it becomes invisible — when it disappears into the moments that make lives better.",
  paragraphs: [
    "My fascination with computer science began as curiosity and grew into conviction: that artificial intelligence and thoughtful engineering can amplify human potential in ways we are only beginning to understand.",
    "I am drawn to research because it lives at the edge of what we know — where careful thinking meets uncomfortable questions. I want to build systems that learn, but also systems that care; tools that scale, but also tools that listen.",
