...
export default function Achievements() {
  return (
    <section id="achievements" className="relative py-28 md:py-36 overflow-hidden" data-testid="achievements-section">
      <div className="blob w-[480px] h-[480px] bg-[#FF6B6B]/15 -left-20 top-1/3" />
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
          {ACHIEVEMENTS.map((a, i) => (
            <motion.div
              ...
              whileHover={{ y: -4 }}
              className="glass rounded-2xl p-5 md:p-6 group hover:border-[#FF6B6B]/30 transition-colors"
            ...
            >
              ...
              <div className="text-xs md:text-sm text-white/65 leading-tight font-medium">
                {a.label}
              </div>
            </motion.div>
          ))}
